...
%                     molecules=Levy(molecules,sigma,beta,best);
...
[Smell_Object,Pos]=min(Best_Object);
...
%% End of Program
smell=round(molecules(Position,:));
